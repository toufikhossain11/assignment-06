    ...
    return (
        <div className=" m-5 lg:flex  w-10/12 mx-auto justify-between items-center ">
            <div className='space-y-2 my-20'>
                ...
                <h2 className='font-bold text-5xl'>Supercharge Your <br /> Digital Workflow</h2>
                ...
                <div className='space-x-2'>
                    <a className="btn bg-gradient-to-r from-[#4F39F6] to-[#9514FA] text-white rounded-3xl">Explore Products</a>
            ...
            <div className=''>
                <img className='h-120' src={Bannar} alt="" />
