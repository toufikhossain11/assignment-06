    ...
    return (
        <div className='w-11/12 mx-auto py-10 space-y-14'>
            <div className=' text-center  space-y-3'>
                ...
                <p className='text-[#627382] text-[13px]'>Start using premium digital tools in minutes, not hours.</p>

            </div>

            <div className=' grid sm:grid-cols-1 lg:grid-cols-3  gap-5 items-center justify-center lg:ml-28'>

                <div className=" w-70 bg-base-100  shadow-sm">
                <div className="text-center p-5 border flex flex-col  items-center space-y-2">
